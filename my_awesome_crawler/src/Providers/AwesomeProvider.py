...
class AwesomeProvider(Provider):
    ...
    def get_chapters(self) -> List[str]:
        return ['http://example.org/manga/awesome/chapter-1.html', 'http://example.org/manga/awesome/chapter-2.html', ...]
    ...
    def get_chapter_images(self, url: str) -> List[str]:
        return ['http://example.org/manga/awesome/image-1.jpg', 'http://example.org/manga/awesome/image-2.jpg', ...]